...
/* HOME WORK STARTS HERE */
template<class T>
class DList : public IteratedLinkedList<T>
{
private:
...
public:
    ...
    {
        if(IteratedLinkedList<T>::num == 0) IteratedLinkedList<T>::begin() = element;
        else
        {
            iterator it = IteratedLinkedList<T>::getBegin();
