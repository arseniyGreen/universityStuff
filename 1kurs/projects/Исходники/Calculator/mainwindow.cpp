...
void MainWindow::on_countButton_clicked()
{
    ...
    if(okX && okY)
    {
        ...
        if(ui->plusButton->isChecked()) //Plus count
        {
            res = x + y;
            QString resText = QString::number(res);
            ui->outputLine->setText(resText);
        }
        if(ui->minusButton->isChecked()) //Min count
        {
            res = x - y;
            QString resText = QString::number(res);
            ui->outputLine->setText(resText);
        ...
        if(ui->multiplyButton->isChecked()) //Mult count
        {
                res = x * y;
                QString resText = QString::number(res);
                ui->outputLine->setText(resText);
        ...
        if(ui->divideButton->isChecked()) //Div count
        {
            res = x / y;
            QString resText = QString::number(res);
            ui->outputLine->setText(resText);
        ...
        if(ui->expButton->isChecked()) //Exp count
        {
            res = pow(x, y);
            QString resText = QString::number(res);
            ui->outputLine->setText(resText);
        }
        if(ui->logButton->isChecked()) //Log count
        {
            if(x < 0)
            {
    ...
    if(!okX) //first is incorrect
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE");
        ui->firstInput->setText("NOT A NUMBER INPUT!");
        ui->firstInput->setPalette(errorPalette);
    }
    if(!okY) //second is incorrect
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE");
        ui->secondInput->setText("NOT A NUMBER INPUT!");
        ui->secondInput->setPalette(errorPalette);
    }
    if(ui->firstInput->text() == "" && ui->secondInput->text() == "") //both are empty
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE");
    ...
    if(ui->firstInput->text() == "") //first is empty
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE");
        ui->firstInput->setText("EMPTY INPUT!");
        ui->firstInput->setPalette(errorPalette);
    }
    if(ui->secondInput->text() == "") //second is empty
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE");
        ui->firstInput->setText("EMPTY INPUT!");
        ui->firstInput->setPalette(errorPalette);
    }
    if(ui->divideButton->isChecked() && ui->secondInput->text() == "0") //by 0 division
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE!");
        ui->secondInput->setText("DIVISION BY NULL!");
        ui->secondInput->setPalette(errorPalette);
    }
    if(ui->expButton->isChecked() && ui->firstInput->text() == "0" && ui->secondInput->text() == "0") //0^0 uncertainty check
    {
        ui->outputLine->setText("ERROR! WATCH ABOVE!");
    ...
    if(qIsInf(res))
    {
        ui->outputLine->setText("ANSWER IS OUT OF RANGE");
    }
}
...
{
    QPalette defaultPalette = (QColor::fromRgb(255,255,255));
    ui->firstInput->clear();
